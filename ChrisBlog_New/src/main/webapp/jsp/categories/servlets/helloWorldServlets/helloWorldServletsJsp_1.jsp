...
<p>
	...
	simple <a href="explanations/web_application" class='dialogLink'>web application</a> 
	using <a href="explanations/java_servlets_technology" class='dialogLink'>Java Servlets Technology</a>.
...
<p>
	...
	<ul>
		...
		<li>
			<b> 
				<a href="explanations/java_virtual_machine" class='dialogLink'>Java Virtual Machine</a>
			</b>: 
			Java in version 5 or higher. This application was tested for Java in version <i>1.6.0_23-ea</i>;
		</li>
		<li>
			<b>
				<a href="explanations/ide" class='dialogLink' 
				>IDE</a>
			</b>: 
			Eclipse Indigo.
		</li>
		<li>
			<b> 
				<a href="explanations/apache_maven" class='dialogLink'>Apache Maven</a>
			tool</b>: 
			Apache Maven tool in version 2 or higher. This application was tested for Apache Maven in version <i>2.2.1</i>;
		</li>
		<li>
			<b> 
				<a href="explanations/application_server" class='dialogLink'>Application Server</a>
			</b>: 
