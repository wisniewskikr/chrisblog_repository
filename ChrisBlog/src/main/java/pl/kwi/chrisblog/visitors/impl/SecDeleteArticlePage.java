...
/**
 * Class with data of page with delete of article in secured area.
 * 
 * @author Krzysztof Wisniewski
 *
 */
public class SecDeleteArticlePage implements IPage {
	
	public final static String TITLE = "Secured Delete of Article";
