...
/**
 * Class with data of page with create of article in secured area.
 * 
 * @author Krzysztof Wisniewski
 *
 */
public class SecCreateArticlePage implements IPage {
	
	public final static String TITLE = "Secured Create of Article";
