...
/**
 * Class with data of page with edit of article content in secured area.
 * 
 * @author Krzysztof Wisniewski
 *
 */
public class SecEditArticleContentPage implements IPage {
	
	public final static String TITLE = "Secured Edit of Article Content";
